...
import 'package:signcom/Quiz_Database/Quiz_Database3.dart';

class Quiz_3 extends StatefulWidget {
  const Quiz_3({Key? key});

  @override
  State<Quiz_3> createState() => _Quiz1State();
}

class _Quiz1State extends State<Quiz_3> {
  var db = DBconnect3();
              ...
              children: [
                ...
                GestureDetector(
                  onTap: () async {
                    ...
                    await FirebaseFirestore.instance.collection('quiz_results3').add({
                      'userId': userId,
                      'quizType': 'Quiz 3: Greetings and Polite Expressions',
                      'result': score,
                      'questionLength': 10,
                    ...
                    setState(() {
                        ...
                        _InputButtonUserState(userId!, lesson1Pressed, lesson2Pressed, allowAccesstoQuiz1, allowAccesstoQuiz2, lesson3Pressed, allowAccesstoQuiz3, lesson4Pressed);
                      });
