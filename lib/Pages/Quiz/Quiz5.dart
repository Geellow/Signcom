...
class Quiz_5 extends StatefulWidget {
  const Quiz_5({Key? key});

  @override
  State<Quiz_5> createState() => _Quiz1State();
}

class _Quiz1State extends State<Quiz_5> {
  var db = DBconnect5();
              ...
              children: [
                ...
                GestureDetector(
                  onTap: () async {
                    ...
                    await FirebaseFirestore.instance.collection('quiz_results5').add({
                      'userId': userId,
                      'quizType': 'Quiz 5: Pronouns',
                      'result': score,
                      'questionLength': 10,
                    ...
                    setState(() {
                        ...
                        _InputButtonUserState(userId!, lesson1Pressed, lesson2Pressed, allowAccesstoQuiz1, allowAccesstoQuiz2, lesson3Pressed, allowAccesstoQuiz3, lesson4Pressed, allowAccesstoQuiz4, lesson5Pressed, allowAccesstoQuiz5);
                      });
