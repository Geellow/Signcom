...
import 'package:signcom/Quiz_Database/Quiz_Database2.dart';

class Quiz_2 extends StatefulWidget {
  const Quiz_2({Key? key});

  @override
  State<Quiz_2> createState() => _Quiz1State();
}

class _Quiz1State extends State<Quiz_2> {
  var db = DBconnect2();
              ...
              children: [
                ...
                GestureDetector(
                  onTap: () async {
                    ...
                    await FirebaseFirestore.instance.collection('quiz_results2').add({
                      'userId': userId,
                      'quizType': 'Quiz 2: Basic Numbers',
                      'result': score,
                      'questionLength': 10,
                    ...
                    setState(() {
                        ...
                        _InputButtonUserState(userId!, lesson1Pressed, lesson2Pressed, allowAccesstoQuiz1, allowAccesstoQuiz2, lesson3Pressed);
                      });
