...
import 'package:signcom/Quiz_Database/Quiz_Database4.dart';

class Quiz_4 extends StatefulWidget {
  const Quiz_4({Key? key});

  @override
  State<Quiz_4> createState() => _Quiz1State();
}

class _Quiz1State extends State<Quiz_4> {
  var db = DBconnect4();
              ...
              children: [
                ...
                GestureDetector(
                  onTap: () async {
                    ...
                    await FirebaseFirestore.instance.collection('quiz_results4').add({
                      'userId': userId,
                      'quizType': 'Quiz 4: Knowing About Oneself and Question Words',
                      'result': score,
                      'questionLength': 10,
                    ...
                    setState(() {
                        ...
                        _InputButtonUserState(userId!, lesson1Pressed, lesson2Pressed, allowAccesstoQuiz1, allowAccesstoQuiz2, lesson3Pressed, allowAccesstoQuiz3, lesson4Pressed, allowAccesstoQuiz4, lesson5Pressed);
                      });
